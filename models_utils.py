...
class UpSampleBlock3d(nn.Module):
    def __init__(self, in_channels=128, out_channels=128, dims=None, ub=None, norm=None, act=nn.LeakyReLU(0.2)):
        super(UpSampleBlock3d, self).__init__()
        # self.conv = Conv2dELR(in_channels, out_channels, 1, 1, 1, act=nn.LeakyReLU(0.2))
        self.upconv = ConvTranspose3dELR(
            in_channels,
            out_channels,
            4, 2, 1,
            ub=ub,
        ...
        # self.conv = Conv2dELR(2*out_channels, out_channels, 1, 1, 0, act=nn.LeakyReLU(0.2))
