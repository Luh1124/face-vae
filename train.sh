...
CUDA_LAUNCH_BLOCKING=1 python train.py --batch_size=12 --gpu_ids=0,1,3,4,5,6,7 --ext=mainv9fv3_lml-d5-arcface --data_name='vox' --root_dir='../vox-png' --display_server=127.0.0.1 --display_port=8098
