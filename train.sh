...
# python train.py --batch_size=2 --gpu_ids=0,1 --ext=mainv10 --data_name='vox' --root_dir="/home/luh/lh_8T/datasets/vox1/face-video-preprocessing/vox-png/"
CUDA_LAUNCH_BLOCKING=1 python train.py --batch_size=2 --gpu_ids=0,1,2,3,4,5,6,7 --ext=mainv12.1-kpc-gan-d5-l-noganFl --data_name='vox' --root_dir='/home/momobot/repo/code/2.faceanaimation/dataset/vox1/vox-png'
