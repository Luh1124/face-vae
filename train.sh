...
# python train.py --batch_size=8 --gpu_ids=0,1,2,3 --ext=ori_efe --root_dir='/home/lh/repo/datasets/vox-png' 
CUDA_LAUNCH_BLOCKING=1 python train.py --batch_size=4 --gpu_ids=0,1,2,3,4,5,6,7 --ext=main-ori-efe --data_name='vox' --root_dir='/home/momobot/repo/code/2.faceanaimation/dataset/vox1/vox-png'
