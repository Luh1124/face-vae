...
python train.py --batch_size=6 --gpu_ids=0,1,2,3 --ext=mainv9finalv3-lml-dls-newgenmodel-mask-sslr-c100-lp-ld --ckp=214 --root_dir='/home/lh/repo/datasets/vox-png' 
