...
CUDA_LAUNCH_BLOCKING=1 python train.py --batch_size=6 --gpu_ids=1,2 --ext=mainv9fv3_lml-d5-arcface-new --data_name='vox' --ckp=19 --root_dir='/data1/datasets/vox1/vox-png' --display_server=127.0.0.1 --display_port=8098
