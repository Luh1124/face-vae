...
# python train.py --batch_size=2 --gpu_ids=0,1,2,3 --ext=mainv3-lrw --root_dir='/home/luh/repo1/datasets/face-video-preprocessing/vox-png' 
python train.py --batch_size=2 --gpu_ids=0,1 --ext=mainv3-lrw --root_dir='/home/luh/lh_8T/datasets/LRW_Data/LRW_Temp' 
