...
python train.py --batch_size=2 --gpu_ids=0,1 --ext=mainv9finalv1 --data_name='vox' --root_dir='/home/luh/lh_8T/datasets/vox1/face-video-preprocessing/vox-png/' --display_server=127.0.0.1 --display_port=8098
