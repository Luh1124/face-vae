...
def demo(args):
    ...
    for idx, src in enumerate(source_paths):
        ...
        fs = g_models["afe"](s)
        kp_c = g_models["ckd"](s)
        _, _, _, t, s_scale = g_models["hpe_ede"](s)
        with torch.no_grad():
            hp.eval()
        ...
        kp_s, Rs = transform_kp(kp_c+delta_s, yaw, pitch, roll, t, s_scale)
        ...
        for dri in driving_paths:
            ...
            # imageio.mimsave(args.output, output_frames)
<<<<<<< HEAD
            os.makedirs(os.path.dirname(dri) + '_kp_outv9fv3_c_lml', exist_ok=True)
            imageio.imwrite(os.path.dirname(dri) + '_kp_outv9fv3_c_lml' + '/' + f'{idx}_'+os.path.basename(dri) , img_with_kp)
=======
            os.makedirs(os.path.dirname(dri) + '_kp_outv9fv3_lml', exist_ok=True)
            imageio.imwrite(os.path.dirname(dri) + '_kp_outv9fv3_lml' + '/' + f'{idx}_'+os.path.basename(dri) , img_with_kp)
>>>>>>> 3026d68679a72b5364b8f7a96fac244cfb0688a6
...
<<<<<<< HEAD
            imageio.imwrite(os.path.dirname(dri) + '_kp_outv9fv3_c_lml' + '/' + f'{idx}_d_'+os.path.basename(dri), img_d)
=======
            imageio.imwrite(os.path.dirname(dri) + '_kp_outv9fv3_lml' + '/' + f'{idx}_d_'+os.path.basename(dri), img_d)
>>>>>>> 3026d68679a72b5364b8f7a96fac244cfb0688a6
...
<<<<<<< HEAD
    parser.add_argument("--ckp_dir", type=str, default="ckp_1644_mainv9finalv3-lml", help="Checkpoint dir")
=======
    parser.add_argument("--ckp_dir", type=str, default="ckp_1644_mainv9fv3_lml", help="Checkpoint dir")
>>>>>>> 3026d68679a72b5364b8f7a96fac244cfb0688a6
    parser.add_argument("--output", type=str, default="output.gif", help="Output video")
    parser.add_argument("--ckp", type=int, default=113, help="Checkpoint epoch")
